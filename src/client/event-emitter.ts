...
interface Events {
  ...
  playerVolumeChanged: [volume: number, oldVolume: number];
  playerShuffleChanged: [shuffle: boolean];
  playerRepeatChanged: [repeat: PlayerRepeatState, oldRepeat: PlayerRepeatState];
  playerIsPlayingChanged: [isPlaying: boolean];
  playerDeviceChanged: [device: PlayerDevice, oldDevice: PlayerDevice];
  playerPaused: [];
  playerResumed: [];
  playerItemChanged: [item: PlayerState['item'], oldItem: PlayerState['item']];
  playerProgressChanged: [progress: number, oldProgress: number];
